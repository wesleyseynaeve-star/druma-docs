...
| Fleet size | Monthly | Annual (per month) |
|---|---|---|
| 3 – 9 vehicles | €45 | €38 |
| 10 – 24 vehicles | €40 | €33 |
| 25 – 49 vehicles | €36 | €30 |
| 50+ vehicles | €32 | €27 |

Pricing is tiered: if you have 15 vehicles, all 15 are billed at the 10–24 tier rate.

### User Seats

A user seat is required for each dispatcher, fleet manager, planner, or admin who logs in to Druma. Drivers using only the mobile app do not consume a user seat. Minimum 1 seat.

| Number of users | Monthly | Annual (per month) |
|---|---|---|
| 1 – 5 users | €20 | €17 |
| 6 – 10 users | €18 | €15 |
| 11+ users | €16 | €13 |
...
eCMR documents are billed at **€0.40 per signed PDF** — this is a pass-through cost from TransFollow. You are only billed when all three parties have signed and a certified PDF is issued. Failed or cancelled eCMR documents are not charged.
