...
description: "A full breakdown of all six Druma user roles, what each can access, and how to assign them."
icon: "shield-halved"
---
...
- **Admin + Planner** — owner who also dispatches
- **Company Admin + Planner** — senior dispatcher who also manages the platform
