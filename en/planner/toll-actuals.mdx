...
![Toll reconciliation panel showing HERE estimates vs driver actuals per country with colour-coded deltas](/images/placeholder.png)
...
![Individual receipt cards with photo thumbnails inside the reconciliation panel](/images/placeholder.png)
