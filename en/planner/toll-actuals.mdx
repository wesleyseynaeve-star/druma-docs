...
<Steps>
  <Step title="Tap Report, then Log toll">
...
<Card title="Rate Cards" icon="sliders-horizontal" href="/en/admin/rate-cards">
  Configure toll pass-through policy, base surcharges, and per-country overrides.
</Card>

<Card title="Fuel Cards & Imports" icon="fuel" href="/en/integrations/fuel-card-import">
