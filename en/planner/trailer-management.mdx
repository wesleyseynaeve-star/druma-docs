...
![Trailer list page with Add Trailer button](/images/placeholder.png)
...
Trailers without GPS tracking rely on the location field being updated manually by the dispatcher.
