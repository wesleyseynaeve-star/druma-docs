...
Before you start inviting people, think about what each person in your company needs to do. Druma has five distinct roles, and giving someone the right role from the start means they only see what is relevant to their job — nothing more, nothing less.
...
| Create/edit orders | Yes | Yes | No | No | No |
| View orders | Yes | Yes | Yes | No | No |
| Assign vehicles and drivers | Yes | Yes | No | No | No |
| Generate invoices | Yes | Yes | No | No | No |
| Fleet management | Yes | Yes | No | No | No |
| Driver app | No | No | No | Yes | No |
