...
![Work orders list with status badges and cost totals](/images/placeholder.png)
...
![Planning board truck card with amber wrench badge](/images/placeholder.png)
...
<Card title="Post-Trip Vehicle Inspection (DVIR)" icon="clipboard-check" href="/en/driver/post-trip-inspection">
