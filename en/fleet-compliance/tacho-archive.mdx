...
If your telematics provider supports remote tachograph file retrieval, Druma pulls new DDD and TGD files automatically every night. No manual action is required for connected vehicles and drivers.
...
| Webfleet | TachoShare |
| VDO | VDO Connect |
| Geotab | Geotab tacho download |

To enable automatic download, go to **Settings → Integrations** and connect your telematics provider. Once connected, Druma retrieves available files during the nightly sync window and updates the status badges accordingly.

<Note>
Automatic download depends on the telematics provider making the file available remotely. Some older vehicle unit models or driver cards may not support remote retrieval — for these, manual upload is required.
</Note>
