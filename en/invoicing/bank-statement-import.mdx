...
![Bank statement import modal showing file selection, format dropdown, and Import button](/images/placeholder.png)
...
![Import result summary showing parsed, matched, review, duplicate, and error counts](/images/placeholder.png)
