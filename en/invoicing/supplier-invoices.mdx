...
![Supplier master list showing name, VAT, type, and action buttons](/images/placeholder.png)
...
![Review queue showing expanded row with extracted fields, source badge, and action buttons](/images/placeholder.png)
...
![Aged creditors dashboard with summary cards, aging buckets, and supplier table](/images/placeholder.png)
