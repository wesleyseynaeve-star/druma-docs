...
![Invoice review screen showing line items, totals, and the Generate button](/images/placeholder.png)
...
How to reverse or partially correct a sent invoice using a credit note.</Card>

<Card title="e-Factura / ANAF Submission" icon="landmark" href="/en/invoicing/efactura-anaf">
How Druma automatically submits invoices to ANAF's e-Factura system for Romanian clients.</Card>

<Card title="Payment Tracking" icon="money-bill-wave" href="/en/invoicing/payment-tracking">
Recording payments against invoices and tracking outstanding balances.</Card>
