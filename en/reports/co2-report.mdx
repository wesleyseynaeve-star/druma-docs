...
![CO2 report showing total fleet emissions, per-truck breakdown, and per-client breakdown](/images/placeholder.png)
...
<CardGroup cols={2}>
  <Card title="CO2 Reporting in Fleet Settings" icon="truck" href="/en/fleet/co2-reporting">
