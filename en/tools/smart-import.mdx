...
![Smart Import upload screen with drag-and-drop zone and category cards](/images/placeholder.png)
...
![Review Dashboard showing category cards with record counts and an open Fleet table](/images/placeholder.png)
