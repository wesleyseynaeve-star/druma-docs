...
![Post-trip inspection overlay showing checklist items with tri-state toggles](/images/placeholder.png)
...
<Steps>
  ...
  <Step title="Add photos for safety-critical defects">
...
![Fleet Defects tab with open safety-critical items and severity badges](/images/placeholder.png)
